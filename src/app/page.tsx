            ...
            <div className="space-y-6 lg:space-y-8">
              ...
              <div className="space-y-3 pt-2 sm:pt-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm sm:text-base text-gray-700 font-medium">24×7 Emergency Cardiac Care</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="flex-shrink-0 w-5 h-5 bg-green-100 rounded-full flex items-center justify-center">
                    <svg className="w-3.5 h-3.5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm sm:text-base text-gray-700 font-medium">Experienced Cardiologists</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="flex-shrink-0 w-5 h-5 bg-green-100 rounded-full flex items-center justify-center">
                    <svg className="w-3.5 h-3.5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm sm:text-base text-gray-700 font-medium">Advanced Cath Lab</span>
                </div>
              </div>
            </div>

            {/* Right Side - Heart Image */}
            <div className="relative flex-shrink-0 w-full lg:w-auto flex flex-col items-center justify-center">
              {/* Tagline with pink heart icon - Above the image */}
              <div className="inline-flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-pink-500 to-rose-500 rounded-full border-2 border-white/30 shadow-lg backdrop-blur-sm mb-4 lg:mb-4">
              ...
              {/* Heart Image */}
              <div className="relative w-full sm:w-96 h-80 sm:h-96 lg:w-[480px] lg:h-[480px] xl:w-[600px] xl:h-[600px] flex items-center justify-center">
